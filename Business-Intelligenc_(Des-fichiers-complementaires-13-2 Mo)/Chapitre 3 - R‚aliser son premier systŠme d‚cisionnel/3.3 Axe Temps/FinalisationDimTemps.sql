...
ALTER TABLE [dbo].[DimTemps] DROP CONSTRAINT [PKDimTemps]
GO

-- Renommage des colonnes
EXEC sp_rename N'[dbo].[DimTemps].[PKDate]', N'Date', 'COLUMN'
GO
EXEC sp_rename N'[dbo].[DimTemps].[DateNom]', N'Jour', 'COLUMN'
GO
EXEC sp_rename N'[dbo].[DimTemps].[Année]', N'AnneeDate', 'COLUMN'
GO
EXEC sp_rename N'[dbo].[DimTemps].[AnnéeNom]', N'AnneeNom', 'COLUMN'
GO
EXEC sp_rename N'[dbo].[DimTemps].[Semestre]', N'SemestreDate', 'COLUMN'
GO
EXEC sp_rename N'[dbo].[DimTemps].[SemestreNom]', N'SemestreNom', 'COLUMN'
GO
EXEC sp_rename N'[dbo].[DimTemps].[Trimestre]', N'TrimestreDate', 'COLUMN'
GO
EXEC sp_rename N'[dbo].[DimTemps].[TrimestreNom]', N'TrimestreNom', 'COLUMN'
GO
EXEC sp_rename N'[dbo].[DimTemps].[Mois]', N'MoisDate', 'COLUMN'
GO
EXEC sp_rename N'[dbo].[DimTemps].[MoisNom]', N'MoisNom', 'COLUMN'
GO
EXEC sp_rename N'[dbo].[DimTemps].[Semaine]', N'SemaineDate', 'COLUMN'
GO
EXEC sp_rename N'[dbo].[DimTemps].[SemaineNom]', N'SemaineNom', 'COLUMN'
GO
